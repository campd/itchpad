...
var ResourceMap = Class({
  ...
  watchCollection: function(collection) {
    ...
    collection.on("resource-added", this.scheduleRebuild);
    collection.on("resource-removed", this.scheduleRebuild);
  },

  unwatchCollection: function(collection) {
    if (!collection) return;
    collection.off("resource-added", this.scheduleRebuild);
    collection.off("resource-removed", this.scheduleRebuild);
  },
