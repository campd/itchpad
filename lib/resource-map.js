...
var ResourceMap = Class({
  ...
  setProject: function(project) {
    if (this.project) {
      this.project.off("resource-added", this.scheduleRebuild);
      this.project.off("resource-removed", this.scheduleRebuild);
    }
    this.project = project;
    if (this.project) {
      this.project.on("resource-added", this.scheduleRebuild);
      this.project.on("resource-removed", this.scheduleRebuild);
    }
