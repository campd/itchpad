...
var Itchpad = Class({
  ...
  addProjectStores: function() {
    var envDirs = require("sdk/system/environment").env.ITCHPAD_PROJECT_DIRS || "";
    var prefDirs = require("sdk/preferences/service").get("itchpad.project-dirs", "");

    console.log("Environment dirs: " + envDirs);
    console.log("Pref dirs: "+ prefDirs);

    var paths = envDirs.split(':').concat(prefDirs.split(':'));
